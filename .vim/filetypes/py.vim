" smartindent for python commands requiring indentation
autocmd BufRead *.py set smartindent cinwords=if,elif,else,for,while,try,except,finally,def,class


" python_fold script, copied straight in here rather than sourcing in.
" downloaded from http://vim.sourceforge.net/scripts/script.php?script_id=515
" Vim folding file
" Language:	Python
